...
const Convocatorias = () => {
  ...
  const [convocatorias, setConvocatorias] = useState(DATA);

  const goToConditionsScreen = (convocatoria: I_Convocatory) => {
    navigate(`/condiciones/${convocatoria.id_conv}`, { state: convocatoria })
  }
